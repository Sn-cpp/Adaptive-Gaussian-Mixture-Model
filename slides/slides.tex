...
\begin{frame}{Chọn pipeline bằng phép đo}
\centering
\includegraphics[width=.8\textwidth]{fig/fig02.png}
\begin{itemize}
...
\centering
\includegraphics[width=.95\textwidth]{fig/fig04.png}
\end{frame}

\begin{frame}{v1 cắt lưu lượng bus còn một nửa}
\centering
\includegraphics[width=.72\textwidth]{fig/fig05.png}
\begin{itemize}
