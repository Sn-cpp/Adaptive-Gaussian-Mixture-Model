...
from push_relabel_numba import push_relabel, warmup_push_relabel
from morph_numba import (morphological_close, morphological_open,
                         largest_component, warmup_morph)
from fgd_gmm_numba import GrabCutGMM, warmup_fgd_gmm
...
class GrabCutPipeline:
    ...
    def rqstep(self, frame_bgr, update_alpha=-1.0):
        ...
        mog2_mask, bg_prob, elapsed_mog2 = self.gmm.step(planar, update_alpha)
